...
impl FormatLoader for AwqLoader {
    ...
    fn load(
        ...
        ir.metadata
            .insert("source_format", MetaValue::String("AWQ".into()));
        ir.metadata
            .insert("quantization.method", MetaValue::String("awq".into()));
        ...
        ir.quantization = Some(QuantizationStore {
            ...
            description: format!(
                ...
                ir.metadata
                    .get_i64("quantization.group_size")
                    .unwrap_or(128)
            ),
        });
    ...
    header_str.contains("\"quant_type\"") && header_str.contains("awq")
        ...
        || {
            ...
            path.parent().map_or(false, |p| {
                p.join("quant_config.json").exists() || p.join("quantize_config.json").exists()
            })
        }
}
