      ...
      <main className="pt-32 pb-20 px-6">
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            ...
            <h1 className="t-h2 mt-4">Bon retour</h1>
            <p className="mt-2 text-sm text-[color:var(--text-3)]">Connectez-vous pour accéder à l'atelier de conversion.</p>
          </div>

          <div className="rounded-2xl border border-[color:var(--border)] bg-[color:var(--bg-2)] p-7">
            <form onSubmit={onEmailLogin} className="space-y-3">
              <input type="email" required placeholder="vous@entreprise.com" value={email} onChange={e=>setEmail(e.target.value)}
          ...
          <p className="mt-6 text-center text-sm text-[color:var(--text-3)]">
            Pas encore de compte ? <Link to="/signup" className="text-[color:var(--green)] hover:underline">Créer un compte</Link>
          </p>
        </div>
      </main>
      <Footer />
